        ...
        <div className="ServicesContainer" id="services">
            ...
            <div className="ServicesWrapper">
                <div className="ServicesCard">
                    ...
                    <p className="ServicesP">We help reduce your fess and increase your over all revenue</p>
                </div>
                <div className="ServicesCard">
                ...
                <div className="ServicesCard">
                    ...
                    <p className="ServicesP">Unlock our special membership card that return 5% cash back</p>
                </div>
            </div>   
        </div>
    )
